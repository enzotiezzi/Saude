 ...
 */
public class TelaAnmFisicaFragment extends Fragment
{
    private View v;

    public TelaAnmFisicaFragment()
    {
    }

    public static TelaAnmFisicaFragment newInstance()
    {
        return new TelaAnmFisicaFragment();
    }
        ...
        buttonSalvar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                for (int i = 0; i < 5; i++)
                {
                    ...
                    }, SystemURL.URL + "PacienteAnaminesiaFisicas", "post", fisicas.get(i), getActivity());
                }
